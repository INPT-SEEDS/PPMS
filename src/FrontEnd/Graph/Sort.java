...
public class Sort { public Sort() {}
  public static Composition[] sort(Portfolio portfolio) { Tree tree = new Tree(portfolio);
    int compositionsCount = tree.getCompositions().size();
    Composition[] compositions = (Composition[])tree.getCompositions().toArray(new Composition[compositionsCount]);
